  ...
  return (
    <div>
      ...
      <section className="max-w-5xl mx-auto px-6 pt-16 pb-14">
        <h1
          className="text-[clamp(2.5rem,6vw,5.5rem)] leading-[1.0] mb-8 max-w-2xl"
      ...
      <section className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="px-8 md:px-14 py-14 flex flex-col justify-center" style={{ background: "var(--surface)" }}>
          <div className="space-y-5 text-base leading-relaxed" style={{ color: "var(--muted)" }}>
            <p>
              Dick VanRansom's family has been in dairy farming for four generations, stretching back to New York. When he was 12 years old, his grandfather Pete sat him down with a 1923 White Mountain hand-cranked ice cream maker and taught him the only thing he needed to know:
            </p>
            <blockquote
            ...
            <p>
              That machine still sits in the shop today. Not as decoration — as the standard.
            </p>
            <p>
              Dick started Mariposa in Mariposa, California — mariposa means butterfly in Spanish — and moved to San Diego in the summer of 2000. Every batch is still made in-house using a freezer designed to exactly replicate the hand-cranked method.
            </p>
            <p>
              No gimmicks. No expensive mix-ins. No story that needs a press release. Just the ice cream, made the same way it's always been made.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-4">
          <div>
            <h2 className="text-3xl mb-4" style={{ fontFamily: "var(--font-display)" }}>The cold facts</h2>
          ...
          <div>
            {[
              ...
              <div key={f.fact} className="py-4 border-b" style={{ borderColor: "var(--border)" }}>
      ...
      <section style={{ background: "var(--primary)" }}>
        <div className="max-w-5xl mx-auto px-6 py-20">
          <h2 className="text-3xl mb-12" style={{ fontFamily: "var(--font-display)", color: "var(--on-primary)" }}>
          ...
          <div className="space-y-0">
            {[
              ...
              { year: "1970s", event: "At age 12, Dick learns the craft from his grandfather Pete. The lesson: good ingredients, and don't complicate it." },
      ...
      <section className="border-t" style={{ borderColor: "var(--border)" }}>
        <div className="max-w-5xl mx-auto px-6 py-14 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <Link
            href="/flavors"
            className="px-6 py-3 rounded text-sm font-semibold shrink-0 transition-opacity hover:opacity-90"
